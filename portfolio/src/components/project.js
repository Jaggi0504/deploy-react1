    ...
    toggleCategories() {
        if (this.state.activeTab === 0) {
            ...
            return (
                <div className="projects-grid">
                    ...
                    <Card shadow={5} style={{ minWidth: "450", margin: "auto" }} className="card-grid">
                        ...
                        <CardText style={{ color: "green", fontSize: "20px", fontFamily: 'Open Sans Condensed, sans-serif' }} className="card-text">
                            FoodShala <hr />
                            A Food ordering website. The Customer can only order if he/she is logged in else the customer will not be allowed
                            to order any food item. The admin of the Restraunt has the access to edit any detail such as the price of any item
                            and also has the access to check the number of people ordered from the Restraunt along with their email id and dishes.
                    </CardText>
                        <CardActions border>
                            <Button colored href="https://github.com/Jaggi0504/FoodShala">Github</Button>
                        </CardActions>
                    </Card>
                </div>
            )
            ...
            return (
                <div className="projects-grid">
                    <Card shadow={5} style={{ minWidth: "450", margin: "auto" }} className="card-grid">
                        <CardTitle style={{ color: "whitesmoke", height: "176px", background: "url(https://i.morioh.com/67feeaf72f.png) center/cover " }}>
                        </CardTitle>
                        <CardText style={{ color: "green", fontSize: "20px", fontFamily: 'Open Sans Condensed, sans-serif' }}> EUPHORIA <hr />
                        
                    </CardText>
                        <CardActions border>
                            <Button colored href="https://github.com/Jaggi0504/Euphoria">Github</Button>
                        </CardActions>
                    </Card>
                </div>
            )
            ...
            return (
                <div className="projects-grid">
                    ...
                    <Card shadow={5} style={{ minWidth: "450", margin: "auto" }} className="card-grid">
                        ...
                        <CardActions border>
                            <Button colored href="http://foodshala.epizy.com/FoodShala/main.html">Live</Button>
                        </CardActions>
                    </Card>
                </div>
            )
        ...
        return (
            <div className='category-tabs'>
                ...
                activeTab={this.state.activeTab} onChange={(tabId) => this.setState({ activeTab: tabId })} ripple>
                    ...
                    <Tab> <h1 style={{fontSize:"10px", marginTop:"14px"}}> MERN Stack </h1> </Tab>
